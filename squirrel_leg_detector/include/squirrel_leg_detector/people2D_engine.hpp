...
#include <squirrel_leg_detector/lfeatures.hpp>
...
class people2D_engine
{
	...
	public:
		...
		int segmentscanJDC(laserscan_data &scan, std::vector<LSL_Point3D_container> &clusters);
		...
		void detect_people(laserscan_data &scan, std::vector<LSL_Point3D_container> &people);
};
